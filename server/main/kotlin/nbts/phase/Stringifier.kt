...
fun Unifier.stringifyTermS(
    ...
    is C.TermS.QuoteTypeZ -> "`z ${stringifyTypeZ(term.element)}"
    is C.TermS.QuoteTermZ -> "`z ${stringifyTermZ(term.element)}"
    is C.TermS.QuoteTermS -> "`s ${stringifyTermS(term.element)}"
    is C.TermS.Splice -> "$${stringifyTermS(term.element)}"
